...
public class TestCases {
    ...
    public void testCase01() throws InterruptedException {
        ...
        WebElement hockeyTeamsElement = wait
                .until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Hockey Teams')]")));
        ...
        // Locate page 1
        WebElement clickOnPage = wait
                .until(ExpectedConditions.elementToBeClickable(By.xpath("(//ul[@class='pagination']/li/a)[1]")));
    ...
    public void testCase02() {
        ...
        WebElement oscarWiningFilms = wait.until(
                ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'Oscar Winning Films')]")));

        // WebElement oscarWiningFilms =
        // driver.findElement(By.xpath("//a[contains(text(),'Oscar Winning Films')]"));

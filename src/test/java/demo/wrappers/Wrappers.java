...
public class Wrappers {
    ...
    public static void scrapHockeyData(WebDriver driver)
        ...
        try {
            ...
            for (int i = 1; i <= 4; i++) {
                ...
                for (WebElement row : rows) {
                    ...
                    teamData.put("win_percentage",
                            Double.parseDouble(row.findElement(By.cssSelector(".pct")).getText()));
    ...
    public static void scrapMoviesData(ChromeDriver driver)
            throws StreamWriteException, DatabindException, IOException, InterruptedException {
            ...
            for (int attempt = 0; attempt < maxRetries; attempt++) {
                try {
                    ...
                    for (int i = 0; i < Math.min(movieRows.size(), 5); i++) {
                        ...
                        String nominations = movieRow.findElement(By.xpath(".//td[@class='film-nominations']"))
                                .getText().trim();
                        ...
                        boolean isWinner = movieRow.findElement(By.xpath(".//td[@class='film-best-picture']"))
                                .findElements(By.tagName("i")).size() > 0;
                    ...
                    if (attempt < maxRetries - 1) {
                        ...
                        System.out.println(
                                "Failed to scrape data for year " + year + " after " + maxRetries + " attempts.");
                    }
                }
            }
